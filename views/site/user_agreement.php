...
<div class="site-user-agreement container" id="user-agreement">
    <h2>
        User Agreement
    </h2>
<br>
    <p style="font-size: larger">The User Agreement (hereinafter referred to as the Agreement) is
    ...
    <p style="font-size: larger">1.1.
            ...
            determined as the venue of the Contractor&rsquo;s registration.
    </p>
    <p style="font-size: larger">1.2.
            ...
            using the Customer&rsquo;s computation capacity.  
    </p>
    <p style="font-size: larger">1.3.
            ...
            the Parties&rsquo; execution of the Agreement. 
    </p>
   
   
    <p style="font-size: large">2.
            Rights and obligations of the Parties. 
    </p>
   
    <p style="font-size: larger">2.1.
            The Contractor.</font></p>
    <p style="font-size: larger">2.1.1.
            ...
            the Agreement terms due to the third parties. 
    </p>
    <p style="font-size: larger">2.1.2.
    ...
    <p style="font-size: larger">2.1.3.
            ...
            markets   on the daily basis. 
    </p>
    <p style="font-size: larger">2.1.4.
            The Contractor, using the third parties&rsquo; assistance, shall
            determine the market potential and share of the securities and
            currency markets   on the daily basis.
    </p>
    <p style="font-size: larger">2.1.5.
            The Contractor, using the third parties&rsquo; assistance, shall
            develop short- and long-term forecast on the situation in the
            securities and currency markets on the daily basis.
    </p>
    <p style="font-size: larger">2.1.6.
            The Contractor, using the third parties&rsquo; assistance, shall make
            ...
            all the expenses connected with the abovementioned activities. 
    </p>
    <p style="font-size: larger">2.1.7.
            The Contractor, using the third parties&rsquo; assistance, shall
            evaluate commercial (market) risks. 
    </p>
    <p style="font-size: larger">2.1.8.
            The Contractor, using the third parties&rsquo; assistance, shall
            ...
            market through third parties&rsquo; assistance. 
    </p>
    <p style="font-size: larger">2.1.9.
    ...
    <p style="font-size: larger">2.1.10.
            The Contractor shall allocate compute capacity required to execute
            the trading strategy at the Customer&rsquo;s expense.  
    </p>
    <p style="font-size: larger">2.1.11.
            The Contractor shall duly fulfill their obligations in terms of the
            Agreement.
    </p>
   
    <p style="font-size: larger">2.2.
            The Customer.</font></p>
    <p style="font-size: larger">2.2.1.
       ...
       <font color="#0000ff"><u><a href="https://nestsecurities.com/">https://nestsecurities.com</font></a></u></font>.
    ...
    <p style="font-size: larger">2.2.1.1.
    ...
    <p style="font-size: larger">2.2.2.
            ...
            account with should be considered as the priority one.     
    </p>
    <p style="font-size: larger">
        2.2.2.1. Should there be any difference
            ...
            return the excessively transferred funds. 
    </p>
    <p style="font-size: larger">2.2.3.
            ...
            about any changes in that data. 
    </p>
    <p style="font-size: larger">2.2.4.
    ...
    <p style="font-size: larger">2.2.5.
            The Customer shall pay for the Contractor&rsquo;s services in the
            amount and in the manner foreseen by the Agreement. 
    </p>
   
    <p style="font-size: larger">3.
            Payment for services.</font></p>
   
    <p style="font-size: larger">3.1.
    ...
    <p style="font-size: larger">3.1.2.
    ...
    <p style="font-size: larger">4.1.
            ...
            considered as the acceptance.  
    </p>
    <p style="font-size: larger">4.2.
    ...
    <p style="font-size: larger">4.3.
            ...
            calendar days before the date of the Agreement termination. 
    </p>
    <p style="font-size: larger">4.4.
    ...
    <p style="font-size: larger">4.6.
            ...
            currently in force of the country the Customer is resident of.      
    </p>
    <p style="font-size: larger">4.7.
    ...
    <p style="font-size: larger">4.9.
            The Contractor&rsquo;s contact information is placed at
            https://nestsecurities.com.</font></p>
    <p style="font-size: larger">4.10.
            ...
            otherwise is foreseen by the Agreement.
    </p>
    <p style="font-size: larger">4.10.1.
            ...
            started their willingness to terminate the Agreement.
    </p>
   
    <p style="font-size: larger">5.
            Risks.</font></p>
   
    <p style="font-size: larger">5.1.
    ...
    <p style="font-size: larger">5.3.
            ...
            of informational, communicative, electronic and other systems.
    </p>
    <p style="font-size: larger">5.4.
    ...
    <p style="font-size: larger">5.5.
            ...
            connected with the data disclosure.   
    </p>
    <p style="font-size: larger">5.6.
    ...
    <p style="font-size: larger">5.7.
            ...
            Agreement or non-studying the Agreement in due time.  
    </p>
   
    <p style="font-size: larger">Please,
            enter the key phrase of<i>I will
                do everything on high professional level and fast </i></font>to
            your request on work execution.<i>
            </i></font>
    </p>
   
   
   
    <p style="font-size: larger">6.
            Personal data processing.</font></p>
   
    <p style="font-size: larger">6.1.
            By registering on website<font color="#0000ff"><u><a href="https://nestsecurities.com/">https://nestsecurities.com</font></a></u></font>
       ...
       <em><span style="font-style: normal">General Data Protection
Regulation.</span></em></p>
   
    <p style="font-size: larger">7.
            Agreement on making transactions.</font></p>
   
    <p style="font-size: larger">7.1.
            Means of communication.</font></p>
    <p style="font-size: larger">7.1.1.
            The Company communicates with the Customer by means of a) telephone;
            b) e-mail.</font></p>
    <p style="font-size: larger">7.1.2.
    ...
    <p style="font-size: larger">7.1.3.
    ...
    <p style="font-size: larger">7.1.4.
    ...
    <p style="font-size: larger">7.1.5.
            ...
            Customer in their sole discretion. 
    </p>
    <p style="font-size: larger">7.1.6.
    ...
    <p style="font-size: larger">7.1.7.
            In case of the Customer&rsquo;s finding out a mistake in the
            ...
            section Contacts on the Company&rsquo;s website. 
    </p>
   
    <p style="font-size: larger">7.2.
            Procedure of Customer&rsquo;s funds transferring to their virtual
            account. 
    </p>
    <p style="font-size: larger">7.2.1.
            ...
            to the Company&rsquo;s account. 
    </p>
    <p style="font-size: larger">7.2.2.
            ...
            jurisdiction of which the transfer is considered.   
    </p>
    <p style="font-size: larger">7.2.3.
            ...
            the Customer are to be paid by the Customer.    
    </p>
    <p style="font-size: larger">7.2.4.
            ...
            exchange rate indicated in the private area. 
    </p>
    <p style="font-size: larger">7.2.5.
            The Company has a right to implement limitation of the minimal and
            maximal sums of transferred funds. 
    </p>
    <p style="font-size: larger">7.2.6.
            ...
            fees and the rest of the expenses foreseen by the Regulation. 
    </p>
    <p style="font-size: larger">7.2.7.
    ...
    <p style="font-size: larger">7.2.8.
            ...
            sum from the Customer&rsquo;s funds.      
    </p>
    <p style="font-size: larger">7.2.9.
    ...
    <p style="font-size: larger">7.3.
            Methods of the Customer&rsquo;s account replenishment. 
    </p>
    <p style="font-size: larger">7.3.1.
            Digital transfer.</font></p>
    <p style="font-size: larger">7.3.1.1.
            ...
            Company&rsquo;s support of that methods of replenishment.
    </p>
    <p style="font-size: larger">7.3.1.2.
            The Customer can make a digital transfer of their funds to the
            Company&rsquo;s account from their personal digital account. 
    </p>
    <p style="font-size: larger">7.3.1.3.
            Before making the digital transfer the Customer shall check the
            details indicated in the private area to avoid making a mistake.
    </p>
    <p style="font-size: larger">7.3.1.4.
            ...
            the amount of funds in the Customer&rsquo;s virtual account.
    </p>
    <p style="font-size: larger">7.4.1.
    ...
    <p style="font-size: larger">7.4.2.
            ...
            Agreement concluded by the Company and the Customer.
    </p>
    <p style="font-size: larger">7.4.3.
            The Customer should draw up a claim to transfer funds to their own
            external account in US dollars.
    </p>
    <p style="font-size: larger">7.4.4.
            ...
            of making the conversion transaction.
    </p>
    <p style="font-size: larger">7.4.5.
            ...
            funds in the Customer&rsquo;s account.
    </p>
    <p style="font-size: larger">7.4.6.
    ...
    <p style="font-size: larger">7.4.7.
            The Company undertakes the obligation not to charge the Customer
    ...
    <p style="font-size: larger">7.4.8.
            ...
            from the Customer&rsquo;s account.
    </p>
    <p style="font-size: larger">7.4.9.
            The Company is considered to have accepted the claim in case it was
            drawn up by the Customer through their private area.  
    </p>
    <p style="font-size: larger">7.4.10.
            ...
            Company as the order to act. 
    </p>
    <p style="font-size: larger">7.4.11.
    ...
    <p style="font-size: larger">7.4.11.1.
            ...
            payment systems and then rest of the required actions. 
    </p>
    <p style="font-size: larger">7.4.12.
            ...
            Customer with a screenshot as a proof of making the transfer. 
    </p>
    <p style="font-size: larger">7.4.13.
            ...
            the sum from the Customer&rsquo;s account.   
    </p>
    <p style="font-size: larger">7.4.14.
    ...
    <p style="font-size: larger">7.4.15.
            ...
            off from the Customer&rsquo;s account.   
    </p>
   
    <p style="font-size: larger">7.5.
            Methods used for writing off funds.
    </p>
    <p style="font-size: larger">7.5.1.
            Digital transfer. 
    </p>
    <p style="font-size: larger">7.5.1.1.
            ...
            type of making funds transfer at the moment of the claim drawing up.
    </p>
    <p style="font-size: larger">7.5.1.2.
            The Customer has a right to draw up a claim to transfer funds to
            their own digital account. 
    </p>
    <p style="font-size: larger">7.5.1.3.
            ...
            Customer&rsquo;s private area. 
    </p>
    <p style="font-size: larger">7.5.1.4.
            ...
            fault.</font></p>
    <p style="font-size: larger">7.5.1.5.
            ...
            the Agreement or the Offer.  
    </p>
   
    <p style="font-size: larger">7.6.
            Rules of the Private Area usage.
    </p>
    <p style="font-size: larger">7.6.1.
            By signing the Agreement the Customer agrees with all the clauses of
            the Agreement regulating usage of the private area.
    </p>
    <p style="font-size: larger">7.6.2.
    ...
    <p style="font-size: larger">7.6.3.
            The Customer undertakes the obligation to timely providing the
            Company with information on changing of any identification data.
    </p>
    <p style="font-size: larger">7.6.4.
            ...
            failure providing the requested documents.   
    </p>
    <p style="font-size: larger"><a name="_GoBack"></a>
        7.6.5. Entrance to the private area
            should protected with a password. 
    </p>
    <p style="font-size: larger">7.6.5.1
            ...
            Customer sets them during following the registration procedure.
    </p>
    <p style="font-size: larger">7.6.5.2.
            The Customer bears full responsibility for keeping the password in
            secret to deny any unauthorized entrance by a third party.
    </p>
    <p style="font-size: larger">7.6.5.3.
    ...
    <p style="font-size: larger">7.6.5.5.
            ...
            disclosing the password to third parties. 
    </p>
    <p style="font-size: larger">7.6.6.
    ...
    <p style="font-size: larger">7.7.1.
            ...
            days from the moment of the dispute arising.
    </p>
    <p style="font-size: larger">7.7.2.
    ...
    <p style="font-size: larger">7.7.3.
            ...
            character and according to their list indicated in the Agreement. 
    </p>
    <p style="font-size: larger">7.7.4.
            The claim must not contain: a) emotional estimation of the dispute;
            b) insults towards the Company. 
    </p>
    <p style="font-size: larger">7.7.5.
    ...
    <p style="font-size: larger">7.7.6.
    ...
    <p style="font-size: larger">7.8.
            Criteria and signs to identify controversial non-trade operations.
    </p>
    <p style="font-size: larger">7.8.1.
    ...
    <p style="font-size: larger">7.8.2.
    ...
    <p style="font-size: larger">7.8.3.
            ...
            making and interaction with the Customer.
    </p>
    <p style="font-size: larger">7.8.4.
    ...
    <p style="font-size: larger">7.9.
            Conclusion.</font></p>
    <p style="font-size: larger">7.9.1.
    ...
    <p style="font-size: larger">7.9.2.
            ...
            legitimately possesses and uses them. 
    </p>
    <p style="font-size: larger">7.9.3.
            ...
            the country where the Customer is legally resides. 
    </p>
    <p style="font-size: larger">7.9.4.
    ...
    <p style="font-size: larger">7.9.5.
    ...
    <p style="font-size: larger">7.9.6.
    ...
    <p style="font-size: larger">7.9.7.
            ...
            after making the corresponding agreement.
    </p>
    <p style="font-size: larger">7.9.8.
    ...
    <p style="font-size: larger">7.9.9.
    ...
    <p style="font-size: larger">7.9.10.
            The content of the Regulation can be disclosed without restrictions
            in answering to a claim made by any relevant party.  
    </p>
   
    <p style="font-size: larger">8.
            Details.</font></p>
   
    <p style="font-size: larger">The
            Executor</font></p>
    <p style="font-size: larger">Nest
